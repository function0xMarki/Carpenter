...
- Python 3.6+
- `pyzipper` (for password-protected `.zip` parts)
- `p7zip` (optional, for interoperability checks/manual validation)
...
- Encryption uses AES-256 ZIP format via `pyzipper` (compatible with 7-Zip)
